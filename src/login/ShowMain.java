...
import control.BorrrowQuery;
public class ShowMain extends Frame{
	Toolkit tool= getToolkit();
	String url=Login.class.getResource("mainbk.png").getPath();
	...
	//菜单组件
	MenuItem mi_book_add,mi_book_update,mi_book_delete,mi_reader_add,mi_reader_update,mi_reader_delete,mi_query;
	...
	public ShowMain(){
		...
		//menu5.add(menu1);	    
		menu1.add(mi_borrow); menu1.add(mi_query);
		menu1.add(mi_back);	     
		//menu5.add(menu2);
